...
namespace ExpressionLab.DB
{
    ...
    public class FakeMyDbContext : IMyDbContext
    {
        ...
        public System.Collections.Generic.List<UspGetChangeLanguageReturnModel> UspGetChangeLanguage(out int procResult)
        {
            ...
            procResult = 0;
            return new System.Collections.Generic.List<UspGetChangeLanguageReturnModel>();
        }

        public System.Threading.Tasks.Task<System.Collections.Generic.List<UspGetChangeLanguageReturnModel>> UspGetChangeLanguageAsync()
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(UspGetChangeLanguage(out procResult));
        }
        ...
        public System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel> UspGetLanguageInfoByLanguageKey(string languageKey, out int procResult)
        {
            ...
            procResult = 0;
            return new System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel>();
        }

        public System.Threading.Tasks.Task<System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel>> UspGetLanguageInfoByLanguageKeyAsync(string languageKey)
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(UspGetLanguageInfoByLanguageKey(languageKey, out procResult));
        }

...
namespace ExpressionLab.DB
{
    ...
    public class MyDbContext : System.Data.Entity.DbContext, IMyDbContext
    {
        ...
        public System.Collections.Generic.List<UspGetChangeLanguageReturnModel> UspGetChangeLanguage()
        {
            int procResult;
            return UspGetChangeLanguage(out procResult);
        }

        public System.Collections.Generic.List<UspGetChangeLanguageReturnModel> UspGetChangeLanguage(out int procResult)
        {
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<UspGetChangeLanguageReturnModel>("EXEC @procResult = [dbo].[uspGetChangeLanguage] ", procResultParam).ToList();

            procResult = (int) procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<UspGetChangeLanguageReturnModel>> UspGetChangeLanguageAsync()
        {
            var procResultData = await Database.SqlQuery<UspGetChangeLanguageReturnModel>("EXEC [dbo].[uspGetChangeLanguage] ").ToListAsync();
        ...
        public System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel> UspGetLanguageInfoByLanguageKey(string languageKey)
        {
            int procResult;
            return UspGetLanguageInfoByLanguageKey(languageKey, out procResult);
        }

        public System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel> UspGetLanguageInfoByLanguageKey(string languageKey, out int procResult)
        {
            ...
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<UspGetLanguageInfoByLanguageKeyReturnModel>("EXEC @procResult = [dbo].[uspGetLanguageInfoByLanguageKey] @LanguageKey", languageKeyParam, procResultParam).ToList();

            procResult = (int) procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<UspGetLanguageInfoByLanguageKeyReturnModel>> UspGetLanguageInfoByLanguageKeyAsync(string languageKey)
        {
            var languageKeyParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@LanguageKey", SqlDbType = System.Data.SqlDbType.NVarChar, Direction = System.Data.ParameterDirection.Input, Value = languageKey, Size = 10 };
            if (languageKeyParam.Value == null)
                languageKeyParam.Value = System.DBNull.Value;

            var procResultData = await Database.SqlQuery<UspGetLanguageInfoByLanguageKeyReturnModel>("EXEC [dbo].[uspGetLanguageInfoByLanguageKey] @LanguageKey", languageKeyParam).ToListAsync();

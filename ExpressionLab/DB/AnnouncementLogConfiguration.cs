...
namespace ExpressionLab.DB
{
    ...
    public class AnnouncementLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AnnouncementLog>
    {
        public AnnouncementLogConfiguration()
            : this("dbo")
        {
        }

        public AnnouncementLogConfiguration(string schema)
        {
            ToTable("AnnouncementLog", schema);
            HasKey(x => x.Id);

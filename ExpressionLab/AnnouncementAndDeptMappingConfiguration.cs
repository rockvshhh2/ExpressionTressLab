...
namespace ExpressionLab
{
    ...
    // AnnouncementAndDeptMapping
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class AnnouncementAndDeptMappingConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AnnouncementAndDeptMapping>
    {
        public AnnouncementAndDeptMappingConfiguration()
            : this("dbo")
        {
        }

        public AnnouncementAndDeptMappingConfiguration(string schema)
        {
            ToTable("AnnouncementAndDeptMapping", schema);
            HasKey(x => x.Id);
